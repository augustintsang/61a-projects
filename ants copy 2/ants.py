...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not nearest and place.is_hive == False:
...
class ContainerAnt(Ant):
    ...
    def double(self):
        self.damage = self.damage * 2
        self.is_doubled = True
        if self.ant_contained != None and not self.ant_contained.is_doubled:
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while location != None:
            if location.ant != None and not location.ant.is_doubled:
                location.ant.double()
            elif location.ant != None and location.ant.is_container and not location.ant.ant_contained.is_doubled:
                location.ant.ant_contained.double()
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        if self.scared_turns > 0:      
            ...
            elif self.slowed_turns > 0:
                self.slowed_turns -= 1
                if gamestate.time % 2 == 0 and not self.place.entrance.is_hive:
                    self.scared_turns -= 1
                    self.move_to(self.place.entrance)
                else:
                    pass
            elif self.health > 0 and not self.place.entrance.is_hive:
                self.scared_turns -= 1
                self.move_to(self.place.entrance)
        elif self.slowed_turns > 0:
            self.slowed_turns -= 1
            ...
            self.sting(self.place.ant)
        elif self.health > 0 and destination is not None and self.slowed_turns == 0:
            self.move_to(destination)
    ...
    def slow(self, length):
        ...
        # BEGIN Problem EC
        self.slowed_turns = self.slowed_turns + length
        # END Problem EC
